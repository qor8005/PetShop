...
var signUp = document.querySelector('#btnJoin');
...
function isBirthCompleted(){
    ...
    if(!yearPattern.test(yy.value)){
        ...
        let isMonth = isMonthSelected(); // false
        isMonth
    }
    ...
    function isDateCompleted(){
        if(dd.value === ""){
            ...
            let isIdBirthRight = idBirthRight();
            isIdBirthRight
        }
    }
}
...
function idBirthRight(){
    ...
    Number(dd.value) < 1 || 
    Number(dd.value) > 31){
        console.log(Number(dd.value) > 31)
